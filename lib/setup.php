...
function setup() {
  ...
  add_image_size( 'gallery-thumb', 400, 400, true );
   add_image_size( 'fullscreen', 1920, 600, true );
 ...
 */
function assets() {
  wp_enqueue_style('curious/css', Assets\asset_path('styles/main.css'), false, '17.2');

  if (is_single() && comments_open() && get_option('thread_comments')) {
    wp_enqueue_script('comment-reply');
  }

  wp_enqueue_script('curious/js', Assets\asset_path('scripts/main.js'), ['jquery'], '17.2', true);
}
