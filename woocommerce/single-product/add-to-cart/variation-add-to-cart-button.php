...
<?php if ( get_field( 'trade_account_exclusive' ) == NULL ) : ?>
	...
	<div class="d-flex flex-lg-row flex-column align-items-lg-center justify-content-end pt-lg-5 pt-4">

		<div class="woocommerce-variation-add-to-cart variations_button align-lg-self-end">
			<?php do_action( 'woocommerce_before_add_to_cart_button' ); ?>

			<div class="row my-3 my-lg-0 justify-content-end  align-items-center">
				...
				<div class="col">
					<button type="submit" class="btn-primary-bg ms-lg-auto single_add_to_cart_button <?php if ( get_field( 'is_root_product' ) ) : ?>disable-button<?php endif; ?>">Add to basket</button>
				</div>
	...
	<div class="d-flex flex-lg-row flex-column justify-content-between  align-items-baseline mb-5">
